...
import com.printball.demo.camerax.adapter.Media
import java.io.File
...
abstract class BaseFragment<B : ViewBinding>(private val fragmentLayout: Int) : Fragment() {
    ...
    protected val outputDirectory: String by lazy {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            "${Environment.DIRECTORY_DCIM}/x_camera/"
        } else {
            "${requireContext().getExternalFilesDir(Environment.DIRECTORY_DCIM)}/x_camera/"
        }
    }
